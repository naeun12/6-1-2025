                                    ...
                                    <div class="container">
                                        ...
                                        <div class="container py-4 mb-4">
                                            ...
                                            <input type="text" class="form-control form-control-lg mb-2"
                                                ...
                                                placeholder="e.g., GCash, Bank Transfer, PayPal" readonly
    ...
    data() {
        return {
            ...
            payment: {
                ...
                paypal: '/images/tenant/allimagesResouces/PayPal-logo.png',
    ...
    methods: {
        ...
        async displayDorms() {
            try {
                ...
                console.log("Dormitory data:", res.data);
...
.thumbnails-wrapper img.active-thumbnail {
    border-color: #007bff;
}
